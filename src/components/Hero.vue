  ...
  <header class="relative grid">
    ...
    <nav class="absolute z-30 w-full mt-10 px-6">
      <section class="flex justify-between items-center relative z-30">
        ...
        <ul
          class="sm:flex hidden text-white font-alata justify-between items-center"
        >
    ...
    <p
      class="p-6 block absolute text-[40px] leading-10 font-josefin text-white z-10 border-2 top-56 border-p-white mx-6 sm:w-[400px] sm:top-32"
    >
